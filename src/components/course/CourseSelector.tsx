...
import { Check, ChevronDown, MapPin, Flag, Star, Clock } from "lucide-react";
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <Badge variant="secondary" className="text-xs">
                          {selectedCourseData.holes} {language === "en" ? "Holes" : "Hoyos"}
                        </Badge>
              ...
              <Command className="bg-background">
                ...
                <CommandList>
                  <CommandEmpty className="text-muted-foreground p-4">
                    {language === "en" ? "No golf course found." : "No se encontró ningún campo de golf."}
                  </CommandEmpty>
                  <CommandGroup>
