  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-t border-border/5">
      <nav className="w-full">
        <ul className="flex items-center justify-between max-w-xl mx-auto px-4 py-3 pb-safe">
...
const NavItem = ({ 
  ...
  <li>
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          "flex flex-col items-center justify-center gap-1 py-2 px-2 transition-all duration-200",
          isActive 
            ? "text-primary" 
